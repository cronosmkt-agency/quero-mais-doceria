...
Vim pelo site oficial e aguardo a confirmação!`;
  ...
  return (
    <div className="min-h-screen bg-white text-[#1E1118] selection:bg-pink-500/20 pb-24 lg:pb-0">
      ...
      <a
        href={`https://wa.me/5521964639999?text=${encodeURIComponent(
          "Olá! Vim pelo site da Quero Mais Doceria e gostaria de ver como funciona para fechar a compra dele com você."
        )}`}
        target="_blank"
        rel="noreferrer"
