...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Quero Mais Doceria & Cafeteria — Pudim Sem Igual & Tortas | São Pedro" },
      { name: "description", content: "O pudim mais elogiado de Teresópolis, fatias de tortas artesanais, cafés especiais e encomendas para festas em frente à Paróquia São Pedro." },
      { property: "og:title", content: "Quero Mais Doceria e Cafeteria — São Pedro" },
      { property: "og:description", content: "Momentos doces que aquecem o coração: pudim sem igual e tortas artesanais." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", type: "image/svg+xml", href: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='25' fill='#292524'/><text x='50%' y='55%' text-anchor='middle' dominant-baseline='middle' fill='white' font-family='sans-serif' font-weight='800' font-size='40'>QM</text></svg>" },
